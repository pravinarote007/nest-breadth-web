...
from breadth_compute import compute_breadth_row
...
def fetch_historical_breadth(
    ...
    Returns ``(grid_df, missing_symbols, debug)``. Empty grid means
    no usable data — `debug["error"]` carries the reason (holiday,
    too-old date, Yahoo returned empty, etc.).
    """
